...
import net.xstopho.config_screen.screen.entries.*;
import net.xstopho.config_screen.screen.entries.base.BaseEntry;
import net.xstopho.config_screen.screen.entries.primitiv.BooleanValueEntry;
import net.xstopho.config_screen.screen.entries.primitiv.IntegerValueEntry;
import net.xstopho.config_screen.screen.entries.primitiv.StringValueEntry;
